...
class _nav_barState extends State<nav_bar> {
  @override
  int currentindex = 0;
  List<Widget> pages = [home(), wishlist(), cart(), profile()];
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: SvgPicture.asset(AssetIcons.Home),
            label: "home",
            activeIcon: SvgPicture.asset(AssetIcons.Home),
          ),
          BottomNavigationBarItem(
              icon: SvgPicture.asset(AssetIcons.Bookmark), label: "wishlist"),
          BottomNavigationBarItem(
              icon: SvgPicture.asset(AssetIcons.Category), label: "cart"),
          BottomNavigationBarItem(
            icon: SvgPicture.asset(AssetIcons.Profile),
            label: "profile",
          )
        ],
      ),
